...
public class MultipleChasingGhostNearTransition implements Transition {

	
	public MultipleChasingGhostNearTransition() {		
	}
	...
	public String toString() {
		return String.format("Pacman near multiple chasing Ghost");
	}
